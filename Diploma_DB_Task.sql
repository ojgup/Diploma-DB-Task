...
EXEC ADD_PRODUCT @PPRODNAME = 'CALC', @PBUYPRICE = 120, @PSELLPRICE = 100
...
GO
BEGIN
EXEC ADD_PRODUCT_TO_ORDER @PORDERID = 70007, @PPRODIID = 10001, @PQTY = 100, @DISCOUNT = 0.2
END;
GO
...
BEGIN
    ...
    -- IF IT HAS NOT BEEN FULLFILLED THEN
        ...
        IF (SELECT DATETIMEDISPATCHED FROM ORDER2177 WHERE ORDERID = @PORDERID) IS NOT NULL
    ...
    -- ** TRICKY** FOR EACH PRODUCT IN THE ORDER FIND INVENTORY WHICH HAS SUFFICIENT UNITS OF THE PRODUCT IN STOCK 
                ...
                SELECT O.PRODUCTID, O.QUANTITY, P.BUYPRICE
                ...
                FETCH NEXT FROM PRODUCT_CURSOR INTO @PRODUCT, @QUANTITY, @BUYPRICE;
...
EXEC FULLFILL_ORDER @PORDERID = 70003;
...
GO
BEGIN
EXEC ADD_PRODUCT_TO_ORDER @PORDERID = 70003, @PPRODIID = 10001, @PQTY = 1, @DISCOUNT = 0.2
END;
GO
