...
BEGIN
DECLARE @OT AS NVARCHAR(1000)
EXEC GET_PRODUCT_BY_ID @PPRODID=10001, @PRETURNSTRING = @OT OUTPUT
SELECT @OT
END
...
BEGIN 
EXEC MAKE_ACCOUNT_PAYMENT @PACCOUNTID = 30001, @PAMOUNT = -10000000
END
...
BEGIN
    ...
    SET @PRETURNSTRING = (SELECT CONCAT('ACCOUNT ID : ', 
    A.ACCOUNTID, ' ACCTNAME : ', ACCTNAME,' BALANCE : ', BALANCE, 
    ' CREDITLIMIT : ', CREDITLIMIT, ' AUTHORISED : ', A.FIRSTNAME) 
    FROM CLIENTACCOUNT2177 C 
    INNER JOIN AUTHORISEDPERSON2177 A
...
EXEC GET_CLIENT_ACCOUNT_BY_ID @PACCOUNTID = 30002, @PRETURNSTRING = @OT OUTPUT
END;
...
BEGIN
    ...
    -- IF THE PRODUCT HAS NOT ALREADY BEEN ADDED TO THAT ORDER (I.E. PK IS UNIQUE)
            ...
            IF @HASBEENADDED IS NULL
                INSERT INTO ORDERLINE2177 (ORDERID, PRODUCTID,
                QUANTITY, DISCOUNT, SUBTOTAL) VALUES
                (@PORDERID, @PPRODIID, @PQTY, @DISCOUNT, 1)
...
BEGIN
EXEC ADD_PRODUCT_TO_ORDER @PORDERID = 70021, @PPRODIID = 10001, @PQTY = 5, @DISCOUNT = 0.2
END;
